...
void prims(int** edges, int n){
	...
	for(int i=0; i<n-1; i++){
		...
		//Get minVertex i.e unvisted vertex:
		 ...
		 //Explore All the neighbours of Minimum vertex
		 // and upadte parent and weight array according to that:
...
int main(){
	...
	cout <<"Minimum Spanning Tree (MST) using Prim's algorithm is:\t\n  " <<endl;
